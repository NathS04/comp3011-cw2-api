...
| Week 4 | Cursor/Claude | "How to do edit-distance-based word suggestions in Python" | Showed `difflib.get_close_matches()` with correct usage | Correct | Used as suggested with `cutoff=0.6` and `n=5` | Standard library solution was exactly right; no modification needed |
